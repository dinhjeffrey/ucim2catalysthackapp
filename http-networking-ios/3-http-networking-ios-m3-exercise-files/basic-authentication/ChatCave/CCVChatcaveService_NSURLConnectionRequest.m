...
- (void)connection:(NSURLConnection *)connection willSendRequestForAuthenticationChallenge:(NSURLAuthenticationChallenge *)challenge
{
    if ([challenge previousFailureCount] == 0) {
        ...
        NSURLCredential *defaultCred = [storage defaultCredentialForProtectionSpace:[challenge protectionSpace]];
        if (defaultCred) {
            [[challenge sender] useCredential:defaultCred forAuthenticationChallenge:challenge];
            return;
        }
        else {
