...
@property (nonatomic, strong) NSString *joinRoomRequestID;
...
- (void)dealloc
{
    ...
    if (self.joinRoomRequestID) {
        [[CCVChatcaveService sharedInstance] cancelRequestWithIdentifier:self.joinRoomRequestID];
    }
}
